...
public class InventoryParser {
	...
	private final static Path playerDataPath = MinecraftStatsBackendApplication.IS_LOCAL_TEST ? Path.of("G:\\Minecraft Servers\\Azure server\\stats tool testing\\playerdata") : Path.of("E:\\J3L+ Server Live\\webpage\\playerdata");
