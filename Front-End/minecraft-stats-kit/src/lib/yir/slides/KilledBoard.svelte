<script>
    ...
    export let mostKilledBoard;
    export let visible;

    const MIN_INTERNAL_PCT = 25;

    let max = mostKilledBoard[0].value;
    mostKilledBoard = mostKilledBoard.map((item) => ({
        ...item,
...
>
    <h1>Your most frequent victims:</h1>
    <div class="bars-wrapper">
        {#each mostKilledBoard as entry}
